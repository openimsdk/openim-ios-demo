...
class UserDetailTableViewController: UIViewController {
    ...
    private lazy var IDLabel: UILabel = {
        ...
        tap.rx.event.subscribe(onNext: { [weak self] _ in
            ...
            ProgressHUD.success("copySuccessfully".innerLocalized())
    ...
    private lazy var sendMessageBtn: UIButton = {
        ...
        v.setTitle("sendMessage".innerLocalized(), for: .normal)
        v.tintColor = .white
    ...
    private lazy var mediaBtn: UIButton = {
        ...
        v.setTitle("audioAndVideoCall".innerLocalized(), for: .normal)
    ...
    private lazy var addFriendBtn: UIButton = {
        ...
        v.setTitle(" " + "addFriend".innerLocalized(), for: .normal)
        v.tintColor = .white
        v.backgroundColor = UIColor.c0089FF
...
extension UserDetailTableViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    enum RowType {
        ...
        var title: String {
            switch self {
            case .nickName:
                return "searchGroupNicknameIs".innerLocalizedFormat(arguments: "")
            case .joinTime:
                return "joinGroupDate".innerLocalized()
            case .joinSource:
                return "joinGroupMethod".innerLocalized()
            case .profile:
