...
class ProfileTableViewController: OUIIM.ProfileTableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationItem.title = "myInfo".innerLocalized()
    ...
    override func tableView(_: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .gender:
            presentActionSheet(action1Title: "man".innerLocalized(), action1Handler: { [weak self] in
                ProgressHUD.animate()
            ...
            }, action2Title: "woman".innerLocalized()) { [weak self] in
                ProgressHUD.animate()
        ...
        case .identifier:
            ...
            ProgressHUD.success("copySuccessfully".localized())
        case .email:
            updateEmail()
            break
        case .spacer:
